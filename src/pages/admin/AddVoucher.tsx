            ...
            <div className="container-fluid" style={{ padding: '30px' }}>
                <div className="form-section mx-auto" style={{ maxWidth: '800px', backgroundColor: "#f0f0f0", padding: "20px", borderRadius: "8px" }}>
                    <div className="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
                        <h4 className="mb-0 text-dark fw-bold">Thêm Voucher Mới</h4>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-9 d-flex gap-2">
                                <button type="submit" className="btn text-white px-4" style={{ backgroundColor: "#1abc9c" }}>Lưu Voucher</button>
                                <Link to="/admin/voucher-management" className="btn text-white px-4 text-decoration-none" style={{ backgroundColor: "#6c757d" }}>Hủy bỏ</Link>
                            </div>
                        </div>
                    </form>
                </div>
